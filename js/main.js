...
/* harmony import */ var _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/graph-accordion.js */ "./src/js/vendor/graph-accordion.js");
/* harmony import */ var _vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/choices.min.js */ "./src/js/vendor/choices.min.js");
/* harmony import */ var _vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_smoorh_scroll_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/smoorh-scroll.js */ "./src/js/vendor/smoorh-scroll.js");
/* harmony import */ var _vendor_graph_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/graph-modal.js */ "./src/js/vendor/graph-modal.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/graph-accordion.js */ "./src/js/vendor/graph-accordion.js");

if (document.querySelector('.we-offer')) {
  const accordion1 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-1', {
    speed: 300
  });
  const accordion2 = new _vendor_graph_accordion_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion-2', {
    speed: 300
  });
}
...
if (portfolioTabsNav) {
  ...
  const hideMoreItems = selector => {
    if (selector.length > maxItems) {
      ...
      const hiddentems = arr.slice(maxItems, selector.length);
      hiddentems.forEach(el => {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs]);
...
if (relatedSlider) {
  const relatedProSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](relatedSlider, {
    slidesPerView: 1,
    spaceBetween: 30,
    on: {
      init: function () {
...
const historySliger = document.querySelector('.history-slider');
if (historySliger) {
  const workSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](historySliger, {
    spaceBetween: 20,
    slidesPerView: 1,
    navigation: {
...
const heroSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero-slider', {
  ...
  on: {
    init: function () {
      const paginationBulets = document.querySelectorAll('.hero__pag .swiper-pagination-bullet');
      paginationBulets.forEach(el => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ GraphAccordion)
/* harmony export */ });
...
/***/ "./src/js/vendor/smoorh-scroll.js":
/*!****************************************!*\
  !*** ./src/js/vendor/smoorh-scroll.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
